...
import com.szsbay.livehome.devices.DevicesControlManager.DeviceInfo;
...
public interface IDevicesCtrlMethod {
	 ...
	 * @return
	 */
	public boolean setDevicePowerCommon(String deviceId, int power, int soundSet);
	/**
	 * 查询设备所有状态
	 * @param soundSet [0/1]
	 * @return
	 */
	public boolean setQueryDeviceAllStatus(String deviceId, int soundSet);
	/**
	 * 获取所有状态的json字符串
	 * @return String
	 */
	 ...
	 * @return byte[]
	 */
	public boolean setQueryDeviceAllFunctions(String deviceId, int soundSet);
	/**
	 * 保存设备所有功能
	...
	public boolean setAircondition(String deviceId, int power, String mode, String windSpeed, int temperature, 
			int upDownAirDoorControl, String airDoorPosition, int isMute, int isHighEfficient, int isBackgroundLight, 
			int soundSet);

	/** 设置空调专家模式可控状态 */
	public boolean setAirconditionSmartStatus(String deviceId, String smartStatus);

	/** 1 电源 power : 0关，1开 soundSet : 0无声音，1开声音 */
	public boolean setAirconditionPower(String deviceId, int power, int soundSet);

	/** 1 模式 取值：”0”，”1”，”2”，”3”，”4” 说明： ”0”送风， ”1”制热， ”2”制冷， ”3”除湿， ”4”自动 */
	public boolean setAirconditionMode(String deviceId, String mode, int soundSet);

	/** 1 温度 取值：”16”~”32” 说明：16℃~32℃ */
	public boolean setAirconditionTemperature(String deviceId, int temperature, int soundSet);

	/** 1 温度 取值：”16”~”32” 说明：16℃~32℃ */
	public boolean setAirconditionTemperatureExportSales(String deviceId, int temperature, int soundSet);
	
	/** 1 风速 取值：0~63 说明： ”0”自动， ”1”静音风速， ”2”低风风速， ”3”中风风速， ”4”高风风速，“5”1档风， “6” 2档风 ，其他值，越高风速越大 */
	public boolean setAirconditionWindSpeed(String deviceId, String windSpeed, int soundSet);

	/** 水平导风板开停 取值：”0”，”1” 说明： ”0”左右风关，”1”左右风开； 设置功能:左右风门控制[0/1],左风摆[0/1],右风摆[0/1],提示声[0/1]*/
	public boolean setAirconditionHorizontalWind(String deviceId, int horizontalWindControl, int leftWindSwing, int rightWindSwing, int soundSet);

	/** 垂直导风板开停 取值：”0”，”1” 说明： ”0”垂直风关，”1”垂直风开 */
	public boolean setAirconditionVerticalWind(String deviceId, String airDoorPosition, int airDoorControl, int soundSet);

	/** 定时开、关设定 timingValid : 取值示例： 说明： 1 表示设置有效， 0表示设置无效 timingValue :Val=0,取消定时， val[1~20],定时val*0.5小时,val=[21~34]定时10+(val-20) 小时*/
	public boolean setAirconditionTiming(String deviceId, int timingValid, int timingValue, int soundSet);
	...
	public boolean setAirconditionRealTimePowerOn(String deviceId, int power, int minuteValue, int soundSet);

	/** ? 实时关机 power : 说明： 1 表示设置实时开机， 0表示取消实时开机。 h=[0~23],min=[0~59] realTimePowerOnHour : 设定范围：0~23 realTimeMinute :
	 * 设定范围：0~59 */
	public boolean setAirconditionRealTimePowerOff(String deviceId, int power, int minuteValue, int soundSet);
	
	/** 睡眠设定 取值：”0”，”1”，”2”，”3”，”4”， 说明：”0” "off"，”1” "general"，”2” "aged"，”3”"younger", "4" "child"*/
	public boolean setAirconditionSleepMode(String deviceId, String sleepMode, int soundSet);

	/** 节能 取值：”0”，”1” 说明：”0”节能关，”1”节能开 */
	public boolean setAirconditionEnergySaving(String deviceId, int energySaving, int soundSet);

	/** 背景灯 取值：”0”，”1” 说明：”0”灯光关，”1”灯光开 */
	public boolean setAirconditionBackgroundLight(String deviceId, int light, int soundSet);

	/** 显示屏发光 取值：”0”，”1” 说明：”0”灯光关，”1”灯光开 */
	public boolean setAirconditionScreenLight(String deviceId, int light, int soundSet);

	/** LED灯 取值：”0”，”1” 说明：”0”灯光关，”1”灯光开 */
	public boolean setAirconditionLEDLight(String deviceId, int light, int soundSet);

	/** 电加热 取值：0，1 说明：0电加热关，”1”电加热开 */
	public boolean setAirconditionElectricalHeating(String deviceId, int electricalHeating, int soundSet);

	/** 1 强力设定（快速冷热） 取值：”0”，”1” 说明：”0”强力设定关，”1”强力设定开 */
	public boolean setAirconditionEfficient(String deviceId, int fastCooling, int soundSet);

	/** 1 强力设定（快速冷热） 取值：”0”，”1” 说明：”0”强力设定关，”1”强力设定开 */
	public boolean setAirconditionEfficientExportSales(String deviceId, int fastCooling, int soundSet);
	
	/** ？ 静音 取值：”0”，”1” 说明：”0”静音设定关，”1”静音设定开 */
	public boolean setAirconditionMuteMode(String deviceId, int isMuteModeOn, int soundSet);

	/** ？ 风向 取值：”0”，”1” 说明：”0”风向设定关，”1”风向设定开 */
	public boolean setAirconditionWindDirection(String deviceId, int isWindDirectionOn, int soundSet);

	/** ？ 湿度 取值：”0”，”1” 说明：”0”风向设定关，”1”风向设定开 */
	public boolean setAirconditionHumidity(String deviceId, int humidity, int soundSet);

	/** ？ 华氏 摄氏 温度切换显示 取值：”0”，”1” 说明：”0”切换关，”1”切换开 */
	public boolean setAirconditionFahrenheitOrCelsiusSwitch(String deviceId, int isSwitch, int soundSet);

	/** ？ 并用节电 设置功能:并用节电[0/1],提示声[0/1] */
	public boolean setAirconditionAndPowerSavingMode(String deviceId, int isAndPowerSavingMode, int soundSet);

	/** ？双模 设置功能:双模[0/1],提示声[0/1] */
	public boolean setAirconditionDualMode(String deviceId, int isDualMode, int soundSet);

	/** ？室内清洁 设置功能:室内清洁[0/1],提示声[0/1] */
	public boolean setAirconditionIndoorClean(String deviceId, int isIndoorClean, int soundSet);
	
	/** ？室外清洁 设置功能:室内清洁[0/1],提示声[0/1] */
	public boolean setAirconditionOutdoorClean(String deviceId, int isOutdoorClean, int soundSet);

	/** ？设置除烟 设置功能:除烟[0/1],提示声[0/1] */
	public boolean setAirconditionCleanSmoke(String deviceId, int isCleanSmoke, int soundSet);

	/** ？显示亮度 设置功能:显示屏亮度值[0-255],提示声[0/1] */
	public boolean setAirconditionBrightness(String deviceId, int brightness, int soundSet);

	/** ？除湿模式 设置功能:除湿模式[auto/1#/2#/3#/4#/5#/6#/7#],提示声[0/1] */
	public boolean setAirconditionDehumidifyMode(String deviceId, String isDehumidifyMode, int soundSet);

	/** ？自然风 设置功能:自然风[0/1],提示声[0/1] */
	public boolean setAirconditionNaturalWind(String deviceId, int isNaturalWind, int soundSet);
	
	/** ？清新 设置功能:清新[0/1],提示声[0/1] */
	public boolean setAirconditionFreshAir(String deviceId, int isFreshAir, int soundSet);

	/** ？室内外温度切换显示 设置功能:室内外温度切换显示[0/1],提示声[0/1] */
	public boolean setAirconditionIndoorOrOutdoorTemperatureDisplaySwitch(String deviceId, int isSwitch, int soundSet);

	/** ？换风 设置功能:换风[0/1],提示声[0/1] */
	public boolean setAirconditionAirExchange(String deviceId, int isAirExchange, int soundSet);

	/** ？智慧眼 设置功能:智慧眼[0/1],提示声[0/1] */
	public boolean setAirconditionSmartEye(String deviceId, int isSmartEye, int soundSet);

	/** ？室内过滤网清洁复位控制(净化) 设置功能:室内过滤网清洁复位控制[0/1],提示声[0/1] */
	public boolean setAirconditionIndoorFilterCleanReset(String deviceId, int isReset, int soundSet);

	/** ？设置语音 设置功能:语音[0/1],提示声[0/1] */
	public boolean setAirconditionVoice(String deviceId, int isVoice, int soundSet);
	...
	public boolean setDehumidifier(String deviceId, int power, String mode, String windSpeed, int humidity, int soundSet);
	
	/** 电源 power : 0关，1开 soundSet : 0无声音，1开声音 */
	public boolean setDehumidifierPower(String deviceId, int power, int soundSet);

	/** 设置除湿机专家模式可控状态 */
	public boolean setDehumidifierSmartStatus(String deviceId, String smartStatus);

	/** 风速 设置功能:风量[weak/strong/auto]，提示声[0/1] */
	public boolean setDehumidifierWindSpeed(String deviceId, String windSpeed, int soundSet);

	/** 模式 设置功能:模式[continue/normal/auto]，提示声[0/1] */
	public boolean setDehumidifierMode(String deviceId, String mode, int soundSet);

	/** 定时开关机 设置功能：定时有效位[0/1],定时时间[0.5h-23h],提示声[0/1] */
	public boolean setDehumidifierTimingSwitchMachine(String deviceId, int timingEnable, int timingValue, int soundSet);

	/** 湿度 湿度值 设置功能:加湿机设置[40/80]，提示声[0/1] */
	public boolean setDehumidifierHumidityValue(String deviceId, int humidityValue, int soundSet);

	/** 温度 设置功能 ：温度值[18-30]，提示声[0/1] */
	public boolean setDehumidifierTemperature(String deviceId, int temperature, int soundSet);

	/** 电加热 开关 设置功能:电加热[0/1]，提示声[0/1] */
	public boolean setDehumidifierElectricalHeating(String deviceId, int electricalHeating, int soundSet);

	/** 水泵 开关 设置功能:水泵[0/1]，提示声[0/1] */
	public boolean setDehumidifierWaterPumpPower(String deviceId, int waterPump, int soundSet);

	/** 负离子 开关 设置功能:负离子 开关[0/1]，提示声[0/1] */
	public boolean setDehumidifierAnionPower(String deviceId, int anionPower, int soundSet);
	...
	public boolean setAircleaner(String deviceId, int power, String mode, String windSpeed, int anionPower, int humidifierPower, int humidity, int soundSet);

	/** 设置空气净化器专家模式可控状态 */
	public boolean setAircleanerSmartStatus(String deviceId, String smartStatus);

	/** 电源 power : 0关，1开 soundSet : 0无声音，1开声音 */
	public boolean setAircleanerPower(String deviceId, int power, int soundSet);

	/** 风速 设置功能:风量[weak/middle/strong/clear/auto]，提示声[0/1] */
	public boolean setAircleanerWindSpeed(String deviceId, String windSpeed, int soundSet);

	/** 模式 设置功能:模式[cleardust/clearsmell/smart/mute/sleep]，提示声[0/1] */
	public boolean setAircleanerMode(String deviceId, String mode, int soundSet);
	...
	public boolean setAircleanerTimingSwitchMachine(String deviceId, int timingEnable, int timingValue, int soundSet);

	/** 儿童锁 开关 设置功能:儿童锁[0/1]，提示声[0/1] */
	public boolean setAircleanerChildClockPower(String deviceId, int childClockPower, int soundSet);

	/** 水离子 开关 设置功能:儿童锁[0/1]，提示声[0/1] */
	public boolean setAircleanerWaterIonPower(String deviceId, int waterIonPower, int soundSet);

	/** 加湿器开关 设置功能:加湿机开关[0/1]，提示声[0/1] */
	public boolean setAircleanerHumidifierPower(String deviceId, int humidifierPower, int soundSet);

	/** 加湿 湿度值 设置功能:加湿机设置[40/80]，提示声[0/1] */
	public boolean setAircleanerHumidityValue(String deviceId, int humidityValue, int soundSet);
	...
	public boolean setAirfan(String deviceId, int power, String mode, String windSpeed, int soundSet);

	/** 设置新风机专家模式可控状态 */
	public boolean setAirfanSmartStatus(String deviceId, String smartStatus);

	/** 电源 power : 0关，1开 soundSet : 0无声音，1开声音 */
	public boolean setAirfanPower(String deviceId, int power, int soundSet);

	/** 风速 设置功能:风量[weak/middle/strong/auto]，提示声[0/1] */
	public boolean setAirfanWindSpeed(String deviceId, String windSpeed, int soundSet);

	/** 模式 设置功能:模式[fullheat/direct/indoor/auto]，提示声[0/1] */
	public boolean setAirfanMode(String deviceId, String mode, int soundSet);

	/** 定时开关机 设置功能:普通定时开关机[0.5h-23h],普通定时有效位[0/1]，提示声[0/1]
	 * 定时时间格式严格为[1.0h,2.0h,3.0h,4.0h,5.0h,6.0h,7.0h,8.0h,9.0h,10h,11h,12h,13h,14,15h,16,17h,18h,19h,20h,21h,22,23h], */
	public boolean setAirfanTimingSwitchMachine(String deviceId, int timingEnable, int timingValue, int soundSet);
	...
	/** 设置新风机专家模式可控状态 */
	public boolean setSensorsSmartStatus(String deviceId, String smartStatus);
	
	/** PM2.5开关设置 设置功能：power[1] */
	public boolean setSensorsPM25Power(String deviceId, int power);
	
	/** 传感器电源控制 切断 上电 电源控制：power[0/1] 传感器ID: [1 温度、2湿度、3 甲醛、4 PM2.5] */
	public boolean setSensorsPower(String deviceId, int power, int sensorID);

	/** 主动上报频率设置 是否设置上报频率：responseFrequencyValid[0/1] 传感器ID responseID : [1 温度、2湿度、3 甲醛、4 PM2.5] 上报频率(单位 秒)：responseFrequency */
	public boolean setResponseFrequency(String deviceId, int responseFrequencyValid, int responseID, int responseFrequency);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartcurtainMode(String deviceId, int mode);
	...
	public boolean setSmartcurtainPosition(String deviceId, int position);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightPower(String deviceId, int power);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightBrightness(String deviceId, int brightnessValue);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightRGB(String deviceId, int redValue, int greenValue, int blueValue);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightAirQualityLevel(String deviceId, int airQualityLevel);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightColorTemperature(String deviceId, int colorTemperatureValue);
	 ...
	 * @return 成功或失败
	 */
	public boolean setSmartlightDeviceStatus(String deviceId, int deviceStatus);
	 ...
	 * @return boolean
	 */
	public boolean setVoltameterPower(String deviceId, int power);
	 ...
	 * @return boolean
	 */
	public boolean setVoltameterResetCount(String deviceId, int isResetCount);
