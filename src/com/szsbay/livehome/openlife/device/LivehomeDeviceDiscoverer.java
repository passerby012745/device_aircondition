...
public class LivehomeDeviceDiscoverer implements IDeviceDiscoverer
{
	 ...
	 * 设备发现等待表
	 */
	private ConcurrentHashMap<String, JSONObject> devicesWaitMap = new ConcurrentHashMap<String, JSONObject>();
	...
	private class DiscoverThread extends LivehomeThread
	{
		...
		protected void onRun() 
		{
			...
			logger.d("<DiscoverThread:{}>exit!!!", DeviceProtocol.deviceName);
		}
	}
