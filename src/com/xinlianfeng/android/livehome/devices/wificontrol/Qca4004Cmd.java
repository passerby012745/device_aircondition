...
public class Qca4004Cmd extends DevicesLogic implements IWifiLogic{
	...
	public static int XLF_JSON_MAGIC   = 0x66BB;
...
//			SetDeivesAddress(Util.changeStringToInterger(dev_type.substring(2, 4)));
			...
			dev_status_change=String.valueOf((temp & 0x01));
			dev_smartmode_ctrl=String.valueOf((temp & 0x02)>>1);
//			if(length!=At_Modle_Num){
//				LogUtils.e("Save_WifiDevicesCommunication", "Save_WifiDevicesCommunication length error!!");
//				return false;
//			}
...
//	}
	...
	/*public byte[] jStringQueryModule(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.XM_AT_PROTOCAL_NOTE_AUTHENTICATE,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	 
	// query module version: WFV
	public byte[] jStringQueryModuleVersion(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_WIFI_MODULE_VERSION,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringQueryWifiStatus(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_WIFI_MODULE_STATUS,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringClearConfigPars(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_CLEAR_WIFI_CONFIG_PARS,
															"AckFlag",0,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringGetModuleMac(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_APPLIANCE_WIFI_MAC,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringQueryRSInfo(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_CDN_INFO,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringConfigRSInfo(String domainname, String port){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_SET_CDN_INFO,
															"AckFlag",1,
															"Sequence",json_sequence++,
															"Ip",domainname,
															"Port",port);
	...
	public byte[] jStringQueryRouterInfo(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_AP,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringConfigRouterInfo(String ssid, String password){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_SET_AP,
															"AckFlag",1,
															"Sequence",json_sequence++,
															"Ssid",ssid,
															"Password",password);
	...
	public byte[] jStringRequestConnectRemote(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_CONFIG_CONNCT_REMOTE,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringQueryModuleServerIp(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_SERVER_IP,
															"AckFlag",1,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringSwitchApMode(){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_CONFIG_CONNECT_TO_AP,
															"AckFlag",0,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringSetLocalFlag(String flag){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_SET_LOCAL_FLAG,
															"AckFlag",0,
															"Sequence",json_sequence++,
															"Loc_flag",flag);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	...
	public byte[] jStringSetProtocolVersion(String version){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_SET_PROTOCOL_VERSION,
															"AckFlag",0,
															"Sequence",json_sequence++,
															"Pro_ver",version);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	...
	public byte[] jStringHttpUpdateModule(String url){
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_HTTP_OTA,
															"AckFlag",0,
															"Sequence",json_sequence++,
															"URL",url);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	...
	public byte[] jStringGetDevSmartModeCtrl() {
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_GET_DEV_CMD_30,
															"AckFlag",0,
															"Sequence",json_sequence++);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	}
	...
	public byte[] jStringSetDevReportFlag(String flag) {
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_SET_DEVREPORT_FLAG,
															"AckFlag",1,
															"Sequence",json_sequence++,
															"Flag",flag);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	...
	public byte[] jStringConfigDevSmartCtrl(String typecmd) {
		String jsonStr = WiFiConTrolUtil.formatStringToJSON("Cmd",AtCmdType.WF_AT_CONFIG_SMARTCTRL,
															"AckFlag",1,
															"Sequence",json_sequence++,
															"Type",typecmd);
		return ProtocolNative.jsonBuildhead(jsonStr, XLF_JSON_MAGIC, 0, 0);
	...
	*/
	...
	public String parseJsonCommand(byte[] result){
		...
		if(null != result) {
			magic = WiFiConTrolUtil.byteArrayToInt(result, 0);
			length = WiFiConTrolUtil.byteArrayToInt(result, 4);
